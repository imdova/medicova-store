...
// ------------- Component -------------
//
export default function BilingualFormLayout() {
  ...
  const t = {
    en: {
      ...
      description: "Add a new customer testimonial to your website",
      form_title: "Title",
    ...
    ar: {
      title: "إنشاء رأي جديد",
      description: "إضافة رأي جديد للعميل إلى موقعك الإلكتروني",
      form_title: "العنوان",
